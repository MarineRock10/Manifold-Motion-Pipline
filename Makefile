...
g1-data :
	...
	python3 -m manifold_motion.demo_spread

.PHONY : g1-bc-train
g1-bc-train :
	python3 -m manifold_motion.bc train --epochs 200
...
.PHONY : g1-sonic-eval
g1-sonic-eval :
	python3 -m manifold_motion.sonic_rl eval --manifolds 10 --steps 4 \
...
.PHONY : g1-ruler
g1-ruler :
	python3 -m manifold_motion.eval_session --clips 3 --per-clip 4 --device cpu

.PHONY : g1-view-data
g1-view-data :
	python3 -m manifold_motion.view_data replay

.PHONY : g1-view-bc
g1-view-bc :
	python3 -m manifold_motion.show_bc
