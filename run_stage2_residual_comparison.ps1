...
$outWin = "C:\Users\$env:USERNAME\Downloads\DeltaForce-Locker-desktop\stage2_residual_comparison.gif"
$outWsl = "/mnt/c/Users/$env:USERNAME/Downloads/DeltaForce-Locker-desktop/stage2_residual_comparison.gif"

wsl.exe -d Ubuntu-22.04 --cd $wslRepo -- /usr/bin/env `
  PYTHONPATH="${wslRepo}:/home/xiyuan/.local/share/sonic-manifold-g1" `
  MUJOCO_GL=egl /usr/bin/python3 -m manifold_motion.stage2_compare_render `
  ...
  --trained-sample reports/manifold_motion/stage2_residual_walk80_test2/sample.npz `
  --trained-executed reports/manifold_motion/stage2_residual_walk80_candidate5_validation_test2/executed.npz `
  --trained-summary reports/manifold_motion/stage2_residual_walk80_candidate5_validation_test2/summary.json `
  --trained-label "Residual Flow candidate 5" `
